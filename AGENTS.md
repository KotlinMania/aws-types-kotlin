...
This file is the quick-reference operating contract for aws-types-kotlin. The longer
...
aws-types-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`aws-types`](https://crates.io/crates/aws-types). Upstream Rust is the behavioral oracle while the
