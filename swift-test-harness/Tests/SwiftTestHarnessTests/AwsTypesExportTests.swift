...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `AwsTypes.swiftmodule/`
...
//      `import AwsTypes` above would fail at compile time.
//
//   2. The static archive `libAwsTypes.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "AwsTypes" }` and
//      `flattenPackage = "io.github.kotlinmania.awstypes"` configuration in
...
//      via the `AwsTypesLibrary` product.
//
