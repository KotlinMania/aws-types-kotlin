...
kotlin {
    ...
    swiftExport {
        moduleName = "AwsTypes"
        flattenPackage = "io.github.kotlinmania.awstypes"
    }

    android {
        namespace = "io.github.kotlinmania.awstypes"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "aws-types-kotlin", version.toString())
    ...
    pom {
        ...
        scm {
            url.set("https://github.com/KotlinMania/aws-types-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/aws-types-kotlin.git")
...
val fullTargetBuildTaskNames = setOf(
    ...
    "assembleAwsTypesXCFramework",
    "assembleAwsTypesDebugXCFramework",
    "assembleAwsTypesReleaseXCFramework",
    "assembleDebugIosFatFrameworkForAwsTypesXCFramework",
    "assembleReleaseIosFatFrameworkForAwsTypesXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForAwsTypesXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForAwsTypesXCFramework",
    "assembleDebugMacosFatFrameworkForAwsTypesXCFramework",
    "assembleReleaseMacosFatFrameworkForAwsTypesXCFramework",
    "assembleDebugTvosFatFrameworkForAwsTypesXCFramework",
    "assembleReleaseTvosFatFrameworkForAwsTypesXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForAwsTypesXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForAwsTypesXCFramework",
    "assembleDebugWatchosFatFrameworkForAwsTypesXCFramework",
    "assembleReleaseWatchosFatFrameworkForAwsTypesXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForAwsTypesXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForAwsTypesXCFramework",
)
